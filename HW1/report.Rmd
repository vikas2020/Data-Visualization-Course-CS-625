...
1. *Under "Pick a location, see the weather forecast", pick a location on the map.  Where was the point you picked near?*
  Windsor VA is the point picked on the map.
...
* Reference [1](https://git.cs.odu.edu/tkennedy/git-workshop/-/wikis/Git-Workshop)
* Reference [2](https://rmarkdown.rstudio.com/docs/articles/rmarkdown.html#tutorials https://www.example.com/reallyreallyreally-extra-long-URI/)
* Reference [3](https://help.tableau.com/current/guides/get-started-tutorial/en-us/get-started-tutorial-home.html)
